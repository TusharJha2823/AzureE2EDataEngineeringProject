...
# MAGIC
# MAGIC The pipeline we create here is a simplified version of the one in the previous unit.
# MAGIC
...
# MAGIC     Note: The pipeline will start with **DLT-Job-Demo-61** and will end with your email address.
